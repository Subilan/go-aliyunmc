	...
	out, err := toml.Marshal(&Config{
		...
		Monitor: MonitorConfig{
			...
			PlayerProfile: PlayerProfile{
				Interval:            300,
				Timeout:             60,
				EssentialsPath:      "/home/mc/server/archive/plugins/Essentials/userdata",
				StatsPath:           "/home/mc/server/archive/world/stats",
				PlayTimeDbFile:      "/home/mc/server/archive/plugins/PlayTimeManager/play_time.db",
				LocalEssentialsPath: "playerprofiles/essentials",
				LocalStatsPath:      "playerprofiles/stats",
				LocalPlayTimeDbFile: "playerprofiles/play_time.db",
			},
		},
		Deploy: DeployConfig{
